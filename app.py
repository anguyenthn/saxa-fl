...
# Load data
df = pd.read_csv("data/NFL2002_2007.csv")

st.title("NFL Analysis on International, Thursday Night, and Away Games (2002–2007)")
## Is it a Away game
...
selected_team = st.sidebar.selectbox("Select Team", sorted(teams))  # Corrected from .selection
